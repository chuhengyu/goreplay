...
class Gor < Formula
  ...
  url "https://github.com/chuhengyu/gor/archive/v0.14.0.tar.gz"
  sha256 "62260a6f5cabde571b91d5762fba9c47691643df0a58565cbe808854cd064dc8"
  head "https://github.com/chuhengyu/gor.git"
  ...
  go_resource "github.com/chuhengyu/elastigo" do
    url "https://github.com/chuhengyu/elastigo.git",
  ...
  def install
    ...
    mkdir_p buildpath/"src/github.com/chuhengyu/"
    ln_sf buildpath, buildpath/"src/github.com/chuhengyu/gor"
